class Pedido < ActiveRecord::Base
  ...
  def desconto_acumulado_geral
    begin
      self.valor = 1 unless self.valor
      self.media_desconto_ponderada_itens_perc = 1 unless self.media_desconto_ponderada_itens_perc
      self.desconto = 1 unless self.desconto
      desc_itens = self.media_desconto_ponderada_itens_perc
      desc_itens = 1 unless desc_itens # tras o desconto ponderado dos itens
